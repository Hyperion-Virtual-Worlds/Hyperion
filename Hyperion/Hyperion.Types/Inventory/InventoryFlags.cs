...
namespace Hyperion.Types.Inventory
{
    ...
    public enum InventoryFlags : uint
    {
        ...
        /// <summary>
        /// When set, apply next owner permissions
        /// instead of base permissions.
        /// </summary> 
        /// <remarks>
        /// Reset when assetid is updated.
        /// </remarks>
        ObjectSlamPerm = 1 << 8,

        /// <summary>
        /// When set the sale information has been changed
        /// </summary> 
        /// <remarks>
        /// Reset when assetid is updated.
        /// </remarks>
        ...
        /// <summary>
        /// When set, the inventory base permissions
        /// are used on rez. When not set, the asset
        /// base permissions are used on rez.
        /// </summary> 
        /// <remarks>
        /// Reset when assetid is updated.
        /// </remarks>
        ...
        /// <summary>
        /// When set, the inventory owner
        /// permissions are used on rez. When not set,
        /// the asset owner permissions are used on rez.
        /// </summary> 
        /// <remarks>
        /// Reset when assetid is updated.
        /// </remarks>
        ...
        /// <summary>
        /// When set, the inventory group
        /// permissions are used on rez. When not set,
        /// the asset group permissions are used on rez.
        /// </summary> 
        /// <remarks>
        /// Reset when assetid is updated.
        /// </remarks>
        ...
        /// <summary>
        /// When set, the inventory everyone permissions
        /// are used on rez. When not set, the asset
        /// everyone permissions are used on rez.
        /// </summary> 
        /// <remarks>
        /// Reset when assetid is updated.
        /// </remarks>
        ...
        /// <summary>
        /// When set, the inventory nextowner
        /// permissions are used on rez. When not set,
        /// the asset nextowner permissions are used on rez.
        /// </summary>
        /// <remarks>
        /// Reset when assetid is updated.
        /// </remarks>
        ...
        /// When set, apply next owner permissions
        /// instead of base permissions.
        /// Triggers setting ObjectSlamPerm.
        /// </summary>
        /// <remarks>
        /// Reset when assetid is updated.
        /// </remarks>
        ...
        /// <summary>
        /// When set the sale information has been changed.
        /// Triggers setting ObjectSlamSale.
        /// </summary> 
        /// <remarks>
        /// Reset when assetid is updated.
        /// </remarks>
