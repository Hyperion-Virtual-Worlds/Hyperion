            ...
            get
            {
                switch (Type)
                {
                    ...
                    case AssetType.CallingCard:
                        return "_callingcard.txt";
                    case AssetType.Landmark:
                        return "_landmark.txt";
                    case AssetType.Clothing:
                        return "_clothing.txt";
                    case AssetType.Object:
                        return "_object.xml";
                    case AssetType.Notecard:
                        return "_notecard.txt";
                    case AssetType.LSLText:
                        return "_script.lsl";
                    case AssetType.LSLBytecode:
                        return "_bytecode.lso";
                    case AssetType.Bodypart:
                        return "_bodypart.txt";
                    case AssetType.Animation:
                        return "_animation.bvh";
                    case AssetType.Gesture:
                        return "_gesture.txt";
                    case AssetType.Simstate:
                        return "_simstate.bin";
                    case AssetType.Mesh:
                        return "_mesh.llmesh";
                    case AssetType.Material:
                        return "_material.xml";
                    case AssetType.Settings:
                        return "_settings.xml";
                    default:
                        throw new ArgumentException("Unmapped asset type " + Type.ToString());
                }
            }
        }
        ...
        public string ContentType
        {
            get
            {
                switch (Type)
                {
                    ...
                    case AssetType.Settings:
                        return "application/vnd.ll.settings";
                    default:
