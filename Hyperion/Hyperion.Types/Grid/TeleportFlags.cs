...
namespace Hyperion.Types.Grid
{
    ...
    public enum TeleportFlags : uint
    {
        ...
        /// <summary>
        /// Teleport request from another user
        /// </summary>
        ViaLure = 1 << 2,

        /// <summary>
        /// Teleport request triggered by landmark
        /// </summary>
        ViaLandmark = 1 << 3,

        /// <summary>
        /// Teleport request triggered by specified location
        /// </summary>
        ViaLocation = 1 << 4,

        /// <summary>
        /// Teleport request triggered by home point
        /// </summary>
        ViaHome = 1 << 5,

        /// <summary>
        /// Teleport request triggered by telehub
        /// </summary>
        ViaTelehub = 1 << 6,

        /// <summary>
        /// Teleport request triggered by login
        /// </summary>
        ViaLogin = 1 << 7,

        /// <summary>
        /// Teleport request triggered by border crossing
        /// </summary>
        ViaGodlikeLure = 1 << 8,
        Godlike = 1 << 9,
        NineOneOne = 1 << 10,
        ...
        /// <summary>
        /// Teleport request triggered by HG teleport
        /// </summary>
        ViaHGLogin = 1 << 30
    }
